...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_0,    DUAL_FUNC_1,                                    KC_SPACE,       DUAL_FUNC_2,    LALT(LGUI(KC_K)),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    OSL(4),         KC_AUDIO_VOL_DOWN,                                KC_AUDIO_VOL_UP,OSL(4)
  ),
  [1] = LAYOUT_voyager(

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    DUAL_FUNC_4,    LCTL(KC_Z),     LCTL(KC_X),     LCTL(KC_C),     DUAL_FUNC_5,    DUAL_FUNC_6,                                    DUAL_FUNC_6,    DUAL_FUNC_5,    LCTL(KC_C),     LCTL(KC_X),     LCTL(KC_Z),     DUAL_FUNC_4,    
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 DUAL_FUNC_7,    KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, LT(6, KC_APPLICATION),KC_LEFT_ALT,    KC_LEFT_CTRL,   KC_LEFT_SHIFT,  DUAL_FUNC_3,                                    DUAL_FUNC_3,    KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_TRANSPARENT, 
    DUAL_FUNC_4,    LCTL(KC_Z),     LCTL(KC_X),     LCTL(KC_C),     DUAL_FUNC_5,    DUAL_FUNC_6,                                    DUAL_FUNC_6,    DUAL_FUNC_8,    KC_PGDN,        KC_PAGE_UP,     DUAL_FUNC_9,    DUAL_FUNC_4,    
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 DUAL_FUNC_7,    KC_TRANSPARENT
  ),
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [6] = LAYOUT_voyager(
    ...
    DUAL_FUNC_4,    KC_EXLM,        KC_SLASH,       KC_LBRC,        KC_RBRC,        KC_HASH,                                        KC_PLUS,        KC_LCBR,        KC_RCBR,        KC_BSLS,        KC_QUES,        DUAL_FUNC_4,    
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 DUAL_FUNC_7,    KC_TRANSPARENT
  ),
  [7] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    DUAL_FUNC_4,    RGB_VAD,        RGB_SPD,        RGB_HUD,        RGB_TOG,        KC_TRANSPARENT,                                 KC_TRANSPARENT, ST_MACRO_7,     ST_MACRO_8,     ST_MACRO_9,     ST_MACRO_10,    DUAL_FUNC_4,    
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 DUAL_FUNC_7,    KC_TRANSPARENT
  ),
  [8] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    DUAL_FUNC_4,    LGUI(KC_6),     LGUI(KC_7),     LGUI(KC_8),     LGUI(KC_9),     ST_MACRO_11,                                    ST_MACRO_12,    LGUI(KC_9),     LGUI(KC_8),     LGUI(KC_7),     LGUI(KC_6),     DUAL_FUNC_4,    
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 DUAL_FUNC_7,    KC_TRANSPARENT
  ),
};

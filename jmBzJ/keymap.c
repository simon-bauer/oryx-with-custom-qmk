...
#define DUAL_FUNC_12 LT(6, KC_T)
#define DUAL_FUNC_13 LT(14, KC_F12)
#define DUAL_FUNC_14 LT(1, KC_1)
#define DUAL_FUNC_15 LT(11, KC_0)
#define DUAL_FUNC_16 LT(12, KC_F)
#define DUAL_FUNC_17 LT(2, KC_F)
#define DUAL_FUNC_18 LT(12, KC_R)
#define DUAL_FUNC_19 LT(5, KC_R)
#define DUAL_FUNC_20 LT(12, KC_F13)
#define DUAL_FUNC_21 LT(15, KC_Y)
#define DUAL_FUNC_22 LT(4, KC_L)
#define DUAL_FUNC_23 LT(7, KC_4)
#define DUAL_FUNC_24 LT(9, KC_2)
#define DUAL_FUNC_25 LT(15, KC_S)
#define DUAL_FUNC_26 LT(4, KC_F19)
#define DUAL_FUNC_27 LT(15, KC_5)
#define DUAL_FUNC_28 LT(5, KC_9)
#define DUAL_FUNC_29 LT(5, KC_2)
#define DUAL_FUNC_30 LT(4, KC_A)
#define DUAL_FUNC_31 LT(7, KC_W)
#define DUAL_FUNC_32 LT(3, KC_Y)
#define DUAL_FUNC_33 LT(9, KC_F5)
#define DUAL_FUNC_34 LT(11, KC_Z)
#define DUAL_FUNC_35 LT(11, KC_F4)
#define DUAL_FUNC_36 LT(10, KC_J)
#define DUAL_FUNC_37 LT(3, KC_F18)
#define DUAL_FUNC_38 LT(11, KC_V)
#define DUAL_FUNC_39 LT(2, KC_F18)
#define DUAL_FUNC_40 LT(3, KC_F23)
#define DUAL_FUNC_41 LT(15, KC_H)
#define DUAL_FUNC_42 LT(12, KC_B)
#define DUAL_FUNC_43 LT(15, KC_F21)
#define DUAL_FUNC_44 LT(8, KC_L)
#define DUAL_FUNC_45 LT(6, KC_F7)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_WH_LEFT,  KC_MEDIA_PREV_TRACK,KC_MS_WH_RIGHT, KC_MS_WH_UP,                                    KC_PAGE_UP,     KC_HOME,        KC_UP,          KC_END,         KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_LEFT_ALT,    KC_MEDIA_NEXT_TRACK,TD(DANCE_2),    KC_MS_DBL_CLICK,ST_MACRO_0,                                     KC_MS_LEFT,     KC_MS_UP,       KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT, 

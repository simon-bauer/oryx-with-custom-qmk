...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, LCTL(KC_X),     LCTL(KC_C),     DUAL_FUNC_1,    LCTL(KC_A),                                     LCTL(KC_A),     DUAL_FUNC_1,    LCTL(KC_C),     LCTL(KC_X),     KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_WWW_FORWARD, KC_F9,          KC_F8,          KC_F7,          DUAL_FUNC_5,                                    DUAL_FUNC_5,    KC_F7,          KC_F8,          KC_F9,          KC_WWW_FORWARD, KC_TRANSPARENT, 
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(combo26, TO(4)),
    COMBO(combo27, TO(4)),
    COMBO(combo28, LCTL(KC_Z)),
    COMBO(combo29, LCTL(KC_Z)),

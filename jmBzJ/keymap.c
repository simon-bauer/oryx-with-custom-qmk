...
#define DUAL_FUNC_9 LT(15, KC_F21)
#define DUAL_FUNC_10 LT(7, KC_F14)
#define DUAL_FUNC_11 LT(1, KC_F5)
#define DUAL_FUNC_12 LT(14, KC_F19)
#define DUAL_FUNC_13 LT(10, KC_F16)
#define DUAL_FUNC_14 LT(9, KC_X)
#define DUAL_FUNC_15 LT(12, KC_F11)
#define DUAL_FUNC_16 LT(11, KC_F20)
#define DUAL_FUNC_17 LT(3, KC_6)
#define DUAL_FUNC_18 LT(5, KC_I)
#define DUAL_FUNC_19 LT(6, KC_A)
#define DUAL_FUNC_20 LT(9, KC_F18)
#define DUAL_FUNC_21 LT(14, KC_F7)
#define DUAL_FUNC_22 LT(9, KC_F9)
#define DUAL_FUNC_23 LT(6, KC_T)
#define DUAL_FUNC_24 LT(5, KC_6)
#define DUAL_FUNC_25 LT(12, KC_B)
#define DUAL_FUNC_26 LT(15, KC_F9)
#define DUAL_FUNC_27 LT(4, KC_F12)
#define DUAL_FUNC_28 LT(4, KC_2)
#define DUAL_FUNC_29 LT(8, KC_F6)
#define DUAL_FUNC_30 LT(7, KC_N)
#define DUAL_FUNC_31 LT(13, KC_5)
#define DUAL_FUNC_32 LT(7, KC_F21)
#define DUAL_FUNC_33 LT(7, KC_O)
#define DUAL_FUNC_34 LT(7, KC_Y)
#define DUAL_FUNC_35 LT(9, KC_5)
#define DUAL_FUNC_36 LT(10, KC_F10)
#define DUAL_FUNC_37 LT(13, KC_Y)
#define DUAL_FUNC_38 LT(13, KC_0)
#define DUAL_FUNC_39 LT(1, KC_C)
#define DUAL_FUNC_40 LT(13, KC_D)
#define DUAL_FUNC_41 LT(12, KC_L)
#define DUAL_FUNC_42 LT(7, KC_P)
#define DUAL_FUNC_43 LT(14, KC_C)
#define DUAL_FUNC_44 LT(5, KC_Z)
#define DUAL_FUNC_45 LT(3, KC_4)
#define DUAL_FUNC_46 LT(8, KC_8)
#define DUAL_FUNC_47 LT(11, KC_K)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MT(MOD_LALT, KC_DELETE),KC_ENTER,       TD(DANCE_2),    KC_MS_DBL_CLICK,ST_MACRO_0,                                     KC_MS_LEFT,     KC_MS_UP,       KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT, 

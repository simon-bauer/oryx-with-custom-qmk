...
#define DUAL_FUNC_11 LT(13, KC_F10)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, DUAL_FUNC_15,   KC_TRANSPARENT, TD(DANCE_2),    KC_MS_DBL_CLICK,KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT, 

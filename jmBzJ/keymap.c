...
#define DUAL_FUNC_4 LT(15, KC_K)
#define DUAL_FUNC_5 LT(5, KC_3)
#define DUAL_FUNC_6 LT(12, KC_F12)
#define DUAL_FUNC_7 LT(8, KC_F19)
#define DUAL_FUNC_8 LT(13, KC_6)
#define DUAL_FUNC_9 LT(13, KC_F17)
#define DUAL_FUNC_10 LT(2, KC_7)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_Q,           KC_W,           KC_F,           KC_P,           KC_B,                                           KC_J,           KC_L,           KC_U,           KC_Y,           TO(4),          KC_TRANSPARENT, 
    DUAL_FUNC_0,    LT(5, KC_A),    MT(MOD_LALT, KC_R),MT(MOD_LCTL, KC_S),MT(MOD_LSFT, KC_T),KC_G,                                           KC_M,           MT(MOD_LSFT, KC_N),MT(MOD_LCTL, KC_E),MT(MOD_LALT, KC_I),LT(5, KC_O),    DUAL_FUNC_0,    
    KC_LEFT_CTRL,   KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         CW_TOGG,        KC_LEFT_CTRL,   
                                                    DUAL_FUNC_1,    OSL(4),                                         MT(MOD_LGUI, KC_F24),KC_SPACE
  ),
  [1] = LAYOUT_voyager(
  ...
  [2] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_2,    KC_TAB,         LSFT(KC_TAB),   DUAL_FUNC_3,                                    DUAL_FUNC_3,    LSFT(KC_TAB),   KC_TAB,         DUAL_FUNC_2,    KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_MS_BTN2,     KC_MS_WH_UP,    KC_MS_WH_DOWN,  KC_MS_BTN1,     DUAL_FUNC_4,                                    DUAL_FUNC_4,    KC_MS_BTN1,     KC_MS_WH_DOWN,  KC_MS_WH_UP,    KC_MS_BTN2,     KC_TRANSPARENT, 
    KC_TRANSPARENT, LCTL(KC_Z),     LCTL(KC_X),     LCTL(KC_C),     DUAL_FUNC_5,    DUAL_FUNC_6,                                    DUAL_FUNC_6,    DUAL_FUNC_5,    LCTL(KC_C),     LCTL(KC_X),     LCTL(KC_Z),     KC_TRANSPARENT, 
                                                    DUAL_FUNC_7,    KC_TRANSPARENT,                                 DUAL_FUNC_8,    MT(MOD_LALT, KC_SPACE)
  ),
  [3] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_2,    KC_TAB,         LSFT(KC_TAB),   DUAL_FUNC_3,                                    DUAL_FUNC_3,    LSFT(KC_TAB),   KC_TAB,         DUAL_FUNC_2,    KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, LT(5, KC_APPLICATION),KC_LEFT_ALT,    KC_LEFT_CTRL,   KC_LEFT_SHIFT,  DUAL_FUNC_4,                                    DUAL_FUNC_4,    KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_TRANSPARENT, 
    KC_TRANSPARENT, LCTL(KC_Z),     LCTL(KC_X),     LCTL(KC_C),     DUAL_FUNC_5,    DUAL_FUNC_6,                                    DUAL_FUNC_6,    DUAL_FUNC_9,    KC_PGDN,        KC_PAGE_UP,     DUAL_FUNC_10,   KC_TRANSPARENT, 
                                                    KC_LEFT_ALT,    KC_TRANSPARENT,                                 DUAL_FUNC_8,    MT(MOD_LALT, KC_SPACE)
  ),
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, LGUI(KC_1),     LGUI(KC_2),     LGUI(KC_3),     LGUI(KC_4),     LGUI(KC_5),                                     LGUI(KC_6),     LGUI(KC_7),     LGUI(KC_8),     LGUI(KC_9),     ST_MACRO_0,     KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 DUAL_FUNC_8,    KC_TRANSPARENT
  ),
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint16_t PROGMEM combo17[] = { KC_D, KC_F17, COMBO_END};
const uint16_t PROGMEM combo18[] = { KC_6, KC_F19, COMBO_END};
const uint16_t PROGMEM combo19[] = { KC_F16, KC_X, COMBO_END};
const uint16_t PROGMEM combo20[] = { KC_8, KC_F15, COMBO_END};
const uint16_t PROGMEM combo21[] = { KC_DOT, KC_F21, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(combo17, OSL(4)),
    COMBO(combo18, KC_UP),
    COMBO(combo19, KC_DOWN),
    COMBO(combo20, KC_HOME),
    COMBO(combo21, KC_END),
};

...
#define DUAL_FUNC_9 LT(2, KC_L)
#define DUAL_FUNC_10 LT(6, KC_F8)
#define DUAL_FUNC_11 LT(10, KC_C)
#define DUAL_FUNC_12 LT(10, KC_F7)
#define DUAL_FUNC_13 LT(14, KC_A)
#define DUAL_FUNC_14 LT(14, KC_F23)
#define DUAL_FUNC_15 LT(2, KC_F10)
#define DUAL_FUNC_16 LT(1, KC_F9)
#define DUAL_FUNC_17 LT(3, KC_O)
#define DUAL_FUNC_18 LT(6, KC_Q)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    OSL(4),         MT(MOD_LALT, KC_A),LT(3, KC_R),    MT(MOD_LCTL, KC_S),MT(MOD_LSFT, KC_T),KC_G,                                           KC_M,           MT(MOD_LSFT, KC_N),MT(MOD_LCTL, KC_E),MEH_T(KC_I),    MT(MOD_LALT, KC_O),OSL(5),         
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, LCTL(KC_Z),     DUAL_FUNC_4,    DUAL_FUNC_5,    KC_MS_DBL_CLICK,DUAL_FUNC_6,                                    KC_TRANSPARENT, DUAL_FUNC_7,    KC_PGDN,        KC_PAGE_UP,     DUAL_FUNC_8,    KC_TRANSPARENT, 
...
const uint16_t PROGMEM combo11[] = { KC_F7, KC_U, COMBO_END};

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   OSL(9),         KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         OSL(9),         KC_LEFT_CTRL,   
                                                    LT(4, KC_SPACE),MO(5),                                          MO(5),          LT(4, KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, LCTL(KC_X),     LCTL(KC_C),     DUAL_FUNC_1,    DUAL_FUNC_2,                                    DUAL_FUNC_2,    DUAL_FUNC_1,    LCTL(KC_C),     LCTL(KC_X),     KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, DUAL_FUNC_3,                                    DUAL_FUNC_3,    KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_9,           KC_8,           KC_7,           LSFT(KC_TAB),                                   LSFT(KC_TAB),   KC_7,           KC_8,           KC_9,           KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_LALT, KC_6),MT(MOD_LCTL, KC_5),MT(MOD_LSFT, KC_4),KC_TAB,                                         KC_TAB,         MT(MOD_LSFT, KC_4),MT(MOD_LCTL, KC_5),MT(MOD_LALT, KC_6),KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_3,           KC_2,           KC_1,           KC_0,                                           KC_0,           KC_1,           KC_2,           KC_3,           KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, DUAL_FUNC_3,                                    DUAL_FUNC_3,    KC_TRANSPARENT
  ),
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_4,    KC_UP,          DUAL_FUNC_5,    KC_PAGE_UP,                                     KC_PAGE_UP,     DUAL_FUNC_5,    KC_UP,          DUAL_FUNC_4,    KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_WWW_FORWARD, KC_F9,          KC_F8,          KC_F7,          DUAL_FUNC_6,                                    DUAL_FUNC_6,    KC_F7,          KC_F8,          KC_F9,          KC_WWW_FORWARD, KC_TRANSPARENT, 
  ...
  [9] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_7,    DUAL_FUNC_8,    DUAL_FUNC_9,    KC_TAB,                                         KC_TAB,         DUAL_FUNC_9,    DUAL_FUNC_8,    DUAL_FUNC_7,    KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint16_t PROGMEM combo14[] = { KC_F, KC_F7, COMBO_END};
const uint16_t PROGMEM combo15[] = { KC_F16, KC_X, COMBO_END};
const uint16_t PROGMEM combo16[] = { KC_T, KC_F9, COMBO_END};
const uint16_t PROGMEM combo17[] = { KC_D, KC_F17, COMBO_END};
const uint16_t PROGMEM combo18[] = { KC_T, KC_R, COMBO_END};
const uint16_t PROGMEM combo19[] = { KC_F17, KC_P, COMBO_END};
const uint16_t PROGMEM combo20[] = { KC_F5, KC_U, COMBO_END};
const uint16_t PROGMEM combo21[] = { KC_6, KC_F19, COMBO_END};
const uint16_t PROGMEM combo22[] = { KC_7, KC_F11, COMBO_END};
const uint16_t PROGMEM combo23[] = { KC_F11, KC_6, COMBO_END};
const uint16_t PROGMEM combo24[] = { KC_F8, KC_7, COMBO_END};
const uint16_t PROGMEM combo25[] = { KC_F9, KC_6, COMBO_END};
const uint16_t PROGMEM combo26[] = { KC_F8, KC_C, COMBO_END};
const uint16_t PROGMEM combo27[] = { KC_8, KC_F15, COMBO_END};
const uint16_t PROGMEM combo28[] = { KC_U, KC_F24, COMBO_END};
const uint16_t PROGMEM combo29[] = { KC_F19, KC_1, COMBO_END};
const uint16_t PROGMEM combo30[] = { KC_4, KC_F15, COMBO_END};
const uint16_t PROGMEM combo31[] = { KC_C, KC_F11, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(combo20, TO(5)),
    COMBO(combo21, TO(5)),
    COMBO(combo22, KC_AUDIO_VOL_UP),
    COMBO(combo23, KC_AUDIO_VOL_DOWN),
    COMBO(combo24, LALT(LGUI(KC_K))),
    COMBO(combo25, LGUI(LSFT(KC_S))),
    COMBO(combo26, TO(4)),
    COMBO(combo27, TO(4)),
    COMBO(combo28, LCTL(KC_A)),
    COMBO(combo29, LCTL(KC_A)),
    COMBO(combo30, CW_TOGG),

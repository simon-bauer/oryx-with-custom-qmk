...
#define DUAL_FUNC_12 LT(9, KC_F4)
...
#define DUAL_FUNC_20 LT(2, KC_F7)
#define DUAL_FUNC_21 LT(10, KC_X)
#define DUAL_FUNC_22 LT(3, KC_F)
#define DUAL_FUNC_23 LT(7, KC_F17)
#define DUAL_FUNC_24 LT(14, KC_A)
#define DUAL_FUNC_25 LT(7, KC_6)
#define DUAL_FUNC_26 LT(15, KC_9)
#define DUAL_FUNC_27 LT(13, KC_F13)
#define DUAL_FUNC_28 LT(10, KC_F13)
#define DUAL_FUNC_29 LT(1, KC_M)
#define DUAL_FUNC_30 LT(5, KC_0)
#define DUAL_FUNC_31 LT(1, KC_F7)
#define DUAL_FUNC_32 LT(15, KC_2)
#define DUAL_FUNC_33 LT(11, KC_F17)
#define DUAL_FUNC_34 LT(12, KC_F7)
#define DUAL_FUNC_35 LT(1, KC_S)
#define DUAL_FUNC_36 LT(14, KC_Y)
#define DUAL_FUNC_37 LT(3, KC_F2)
#define DUAL_FUNC_38 LT(15, KC_F21)
#define DUAL_FUNC_39 LT(14, KC_H)
#define DUAL_FUNC_40 LT(12, KC_F23)
#define DUAL_FUNC_41 LT(2, KC_Y)
#define DUAL_FUNC_42 LT(12, KC_F21)
#define DUAL_FUNC_43 LT(12, KC_5)
#define DUAL_FUNC_44 LT(11, KC_U)
#define DUAL_FUNC_45 LT(6, KC_F2)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, LALT(KC_F4),    KC_MS_WH_LEFT,  KC_MEDIA_PREV_TRACK,KC_MS_WH_RIGHT, KC_MS_WH_UP,                                    KC_PAGE_UP,     KC_HOME,        KC_UP,          KC_END,         KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, MO(5),          MO(3),          MT(MOD_LCTL, KC_MS_BTN2),MT(MOD_LSFT, KC_MS_BTN1),KC_MS_WH_DOWN,                                  KC_PGDN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       LT(6, KC_APPLICATION),KC_TRANSPARENT, 
    KC_TRANSPARENT, MT(MOD_LALT, KC_DELETE),KC_MEDIA_NEXT_TRACK,TD(DANCE_2),    KC_MS_DBL_CLICK,ST_MACRO_0,                                     KC_MS_LEFT,     KC_MS_UP,       KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT, 

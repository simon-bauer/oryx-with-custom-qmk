...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   LT(9, KC_Z),    KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         MO(9),          KC_LEFT_CTRL,   
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, DUAL_FUNC_1,    LCTL(KC_X),     LCTL(KC_C),     DUAL_FUNC_2,    LCTL(KC_A),                                     LCTL(KC_A),     DUAL_FUNC_2,    LCTL(KC_C),     LCTL(KC_X),     DUAL_FUNC_1,    KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, LT(9, KC_WWW_FORWARD),KC_F3,          KC_F2,          KC_F1,          KC_F10,                                         KC_F10,         KC_F1,          KC_F2,          KC_F3,          LT(9, KC_WWW_FORWARD),KC_TRANSPARENT, 

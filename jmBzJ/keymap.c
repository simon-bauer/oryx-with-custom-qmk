...
#define DUAL_FUNC_8 LT(5, KC_F19)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_Q,           KC_W,           KC_F,           KC_P,           KC_B,                                           KC_J,           KC_L,           KC_U,           KC_Y,           KC_Q,           KC_LEFT_SHIFT,  
    ...
    KC_LEFT_CTRL,   KC_Z,           LT(9, KC_X),    KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       LT(9, KC_DOT),  CW_TOGG,        KC_LEFT_CTRL,   
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, LCTL(KC_Z),     DUAL_FUNC_1,    LCTL(KC_C),     DUAL_FUNC_2,    LCTL(KC_Y),                                     LCTL(KC_Y),     DUAL_FUNC_2,    LCTL(KC_C),     DUAL_FUNC_1,    LCTL(KC_Z),     KC_TRANSPARENT, 
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, LT(9, KC_3),    KC_2,           KC_1,           KC_0,                                           KC_0,           KC_1,           KC_2,           LT(9, KC_3),    KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, DUAL_FUNC_3,                                    DUAL_FUNC_3,    KC_TRANSPARENT
  ),
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, LCTL(KC_Z),     DUAL_FUNC_1,    LCTL(KC_C),     DUAL_FUNC_2,    LCTL(KC_Y),                                     LCTL(KC_Y),     DUAL_FUNC_2,    LCTL(KC_C),     DUAL_FUNC_6,    LCTL(KC_Z),     KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, DUAL_FUNC_3,                                    DUAL_FUNC_3,    KC_TRANSPARENT
  ),
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_WWW_FORWARD, LT(6, KC_F3),   KC_F2,          KC_F1,          KC_F10,                                         KC_F10,         KC_F1,          KC_F2,          LT(6, KC_F3),   KC_WWW_FORWARD, KC_TRANSPARENT, 
  ...
  [9] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_8,    DUAL_FUNC_9,    DUAL_FUNC_10,   KC_TRANSPARENT,                                 KC_TRANSPARENT, DUAL_FUNC_10,   DUAL_FUNC_9,    DUAL_FUNC_8,    KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint16_t PROGMEM combo24[] = { KC_F5, KC_U, COMBO_END};
const uint16_t PROGMEM combo25[] = { KC_6, KC_F19, COMBO_END};
...
const uint16_t PROGMEM combo30[] = { KC_F8, KC_C, COMBO_END};
const uint16_t PROGMEM combo31[] = { KC_8, KC_F15, COMBO_END};

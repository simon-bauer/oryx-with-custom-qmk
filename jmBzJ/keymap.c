...
#define DUAL_FUNC_12 LT(8, KC_F21)
#define DUAL_FUNC_13 LT(10, KC_I)
#define DUAL_FUNC_14 LT(10, KC_M)
#define DUAL_FUNC_15 LT(14, KC_P)
#define DUAL_FUNC_16 LT(6, KC_F18)
#define DUAL_FUNC_17 LT(5, KC_F14)
...
const uint16_t PROGMEM combo12[] = { KC_H, KC_COMMA, COMBO_END};

...
#define DUAL_FUNC_6 LT(3, KC_6)
#define DUAL_FUNC_7 LT(12, KC_F12)
#define DUAL_FUNC_8 LT(13, KC_0)
...
#define DUAL_FUNC_20 LT(3, KC_1)
#define DUAL_FUNC_21 LT(1, KC_E)
#define DUAL_FUNC_22 LT(2, KC_F11)
#define DUAL_FUNC_23 LT(9, KC_F5)
#define DUAL_FUNC_24 LT(6, KC_N)
#define DUAL_FUNC_25 LT(10, KC_F11)
#define DUAL_FUNC_26 LT(11, KC_F12)
#define DUAL_FUNC_27 LT(3, KC_F17)
#define DUAL_FUNC_28 LT(12, KC_7)
#define DUAL_FUNC_29 LT(2, KC_Q)
#define DUAL_FUNC_30 LT(15, KC_F15)
#define DUAL_FUNC_31 LT(8, KC_J)
#define DUAL_FUNC_32 LT(10, KC_T)
#define DUAL_FUNC_33 LT(8, KC_6)
#define DUAL_FUNC_34 LT(3, KC_F16)
#define DUAL_FUNC_35 LT(14, KC_F8)
#define DUAL_FUNC_36 LT(1, KC_F18)
#define DUAL_FUNC_37 LT(1, KC_Z)
#define DUAL_FUNC_38 LT(1, KC_Q)
#define DUAL_FUNC_39 LT(6, KC_W)
#define DUAL_FUNC_40 LT(10, KC_5)
#define DUAL_FUNC_41 LT(4, KC_7)
#define DUAL_FUNC_42 LT(13, KC_J)
#define DUAL_FUNC_43 LT(15, KC_K)
#define DUAL_FUNC_44 LT(3, KC_F12)
#define DUAL_FUNC_45 LT(14, KC_F20)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MO(5),          MO(3),          MT(MOD_LCTL, KC_MS_BTN1),MT(MOD_LSFT, KC_MS_BTN1),KC_MS_WH_DOWN,                                  KC_PGDN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       LT(6, KC_APPLICATION),KC_TRANSPARENT, 

...
#define DUAL_FUNC_15 LT(8, KC_J)
#define DUAL_FUNC_16 LT(9, KC_Z)
#define DUAL_FUNC_17 LT(5, KC_F12)
...
const uint16_t PROGMEM combo16[] = { KC_F17, KC_1, COMBO_END};
const uint16_t PROGMEM combo17[] = { KC_F24, KC_T, COMBO_END};

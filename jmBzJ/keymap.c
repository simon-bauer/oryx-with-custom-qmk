...
#define DUAL_FUNC_7 LT(14, KC_F3)
#define DUAL_FUNC_8 LT(14, KC_F9)
#define DUAL_FUNC_9 LT(13, KC_E)
#define DUAL_FUNC_10 LT(4, KC_1)
#define DUAL_FUNC_11 LT(5, KC_E)
#define DUAL_FUNC_12 LT(13, KC_F15)
#define DUAL_FUNC_13 LT(3, KC_B)
#define DUAL_FUNC_14 LT(11, KC_J)
#define DUAL_FUNC_15 LT(7, KC_3)
#define DUAL_FUNC_16 LT(2, KC_9)
#define DUAL_FUNC_17 LT(11, KC_K)
#define DUAL_FUNC_18 LT(1, KC_O)
#define DUAL_FUNC_19 LT(5, KC_H)
#define DUAL_FUNC_20 LT(14, KC_S)
#define DUAL_FUNC_21 LT(3, KC_7)
#define DUAL_FUNC_22 LT(3, KC_G)
#define DUAL_FUNC_23 LT(3, KC_H)
#define DUAL_FUNC_24 LT(10, KC_F21)
#define DUAL_FUNC_25 LT(7, KC_6)
#define DUAL_FUNC_26 LT(5, KC_N)
#define DUAL_FUNC_27 LT(14, KC_F6)
#define DUAL_FUNC_28 LT(6, KC_Y)
#define DUAL_FUNC_29 LT(12, KC_F15)
#define DUAL_FUNC_30 LT(10, KC_8)
#define DUAL_FUNC_31 LT(13, KC_2)
#define DUAL_FUNC_32 LT(3, KC_A)
#define DUAL_FUNC_33 LT(14, KC_1)
#define DUAL_FUNC_34 LT(7, KC_E)
#define DUAL_FUNC_35 LT(10, KC_F14)
#define DUAL_FUNC_36 LT(13, KC_F6)
#define DUAL_FUNC_37 LT(3, KC_M)
#define DUAL_FUNC_38 LT(3, KC_Y)
#define DUAL_FUNC_39 LT(1, KC_F19)
#define DUAL_FUNC_40 LT(4, KC_H)
#define DUAL_FUNC_41 LT(4, KC_F9)
#define DUAL_FUNC_42 LT(1, KC_M)
#define DUAL_FUNC_43 LT(12, KC_S)
#define DUAL_FUNC_44 LT(1, KC_L)
#define DUAL_FUNC_45 LT(5, KC_F16)
#define DUAL_FUNC_46 LT(4, KC_F14)
#define DUAL_FUNC_47 LT(9, KC_1)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_WH_LEFT,  LALT(KC_F4),    KC_MS_WH_RIGHT, KC_MS_WH_UP,                                    KC_PAGE_UP,     DUAL_FUNC_0,    KC_UP,          DUAL_FUNC_1,    KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, LT(5, KC_MEDIA_PREV_TRACK),LT(3, KC_MEDIA_NEXT_TRACK),MT(MOD_LCTL, KC_MS_BTN2),MT(MOD_LSFT, KC_MS_BTN1),KC_MS_WH_DOWN,                                  KC_PGDN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       LT(6, KC_APPLICATION),KC_TRANSPARENT, 
    KC_TRANSPARENT, MT(MOD_LALT, KC_DELETE),ST_MACRO_0,     TD(DANCE_2),    KC_MS_DBL_CLICK,KC_TRANSPARENT,                                 KC_MS_LEFT,     KC_MS_UP,       KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TAB,         KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 ST_MACRO_1,     DUAL_FUNC_2,    DUAL_FUNC_3,    DUAL_FUNC_4,    KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, DUAL_FUNC_5,    DUAL_FUNC_6,    DUAL_FUNC_7,    DUAL_FUNC_8,    KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, DUAL_FUNC_9,    DUAL_FUNC_10,   DUAL_FUNC_11,   KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, MT(MOD_LGUI, KC_0)
  ),
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_F9,          KC_F10,         KC_F11,         DUAL_FUNC_12,   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_F5,          KC_F6,          KC_F7,          DUAL_FUNC_13,   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_F1,          KC_F2,          KC_F3,          DUAL_FUNC_14,   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [8] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, DUAL_FUNC_15,   DUAL_FUNC_16,   DUAL_FUNC_17,   DUAL_FUNC_18,   DUAL_FUNC_19,                                   DUAL_FUNC_32,   DUAL_FUNC_33,   DUAL_FUNC_34,   DUAL_FUNC_35,   KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, DUAL_FUNC_20,   DUAL_FUNC_21,   DUAL_FUNC_22,   DUAL_FUNC_23,   DUAL_FUNC_24,                                   DUAL_FUNC_36,   DUAL_FUNC_37,   DUAL_FUNC_38,   DUAL_FUNC_39,   DUAL_FUNC_40,   KC_TRANSPARENT, 
    KC_TRANSPARENT, DUAL_FUNC_25,   DUAL_FUNC_26,   DUAL_FUNC_27,   DUAL_FUNC_28,   DUAL_FUNC_29,                                   DUAL_FUNC_41,   DUAL_FUNC_42,   DUAL_FUNC_43,   DUAL_FUNC_44,   DUAL_FUNC_45,   KC_TRANSPARENT, 
                                                    DUAL_FUNC_30,   DUAL_FUNC_31,                                   DUAL_FUNC_46,   DUAL_FUNC_47
  ),
  [9] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
